...
class DFANet(nn.Module):
    def __init__(self):
        ...
        error_dim = 10
        self.in_proj = DFAFullyConnected(784, 512, error_dim, activation='silu')
        self.recurrent = DFAFullyConnected(512, 256, error_dim, activation='silu')
        self.out_proj = DFAFullyConnected(256, 10, error_dim, activation='none', last_layer=True)
