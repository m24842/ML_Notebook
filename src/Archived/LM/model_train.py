...
import math
import sys
sys.path.append('src/MultiLinear')
sys.path.append('src/AssociativeMemory')
from model import *

model_name = 'fixed_attn'
model_path = f'src/LM/{model_name}.pth'
optimizer_path = f'src/LM/{model_name}_optimizer.pth'
scheduler_path = f'src/LM/{model_name}_scheduler.pth'
...
def train(net, optimizer, scheduler, dataloader, epochs):
    ...
    plt.savefig(f'src/LM/{model_name}_train_loss.png')
